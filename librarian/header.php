...
$libraian_info_query = mysqli_query($con,"SELECT * FROM `libraian` WHERE `email` = '$libraian_login'");
$libraian_info = mysqli_fetch_assoc($libraian_info_query);
?>
            ...
            <div class="rightside-header">
                ...
                <div class="header-section" id="user-headerbox">
                    <div class="user-header-wrap">
                        ...
                        <div class="user-info">
                            <span class="user-name"><?= ucwords($libraian_info['fast_name'])?></span>
                ...
                <div id="left-nav" class="nano">
                    <div class="nano-content">
                        <nav>
                            ...
                            <li class="<?= $page == 'issu_book.php' ? 'active-item': '' ?>"><a href="issu_book.php"><i class="fa fa-home" aria-hidden="true"></i><span>Issu Book</span></a></li>
