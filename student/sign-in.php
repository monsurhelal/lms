...
if(isset($_POST['sing_in_btn'])){
    
    $email = $_POST['email'];
    $password = $_POST['password'];
    $query = mysqli_query($con,"SELECT * FROM `students` WHERE `email` = '$email' OR `username` = '$email';");
    ...
    if(mysqli_num_rows($query)== 1){
        ...
        $error = "email or user name is invalid";
    }
            ...
            <div class="panel mb-none">
                <div class="panel-content bg-scale-0">
                    <form method="POST" action="<?= $_SERVER['PHP_SELF']?>">
                        ...
                        <div class="form-group">
                            <input type="submit" value="Sign in" name="sing_in_btn" class="btn btn-primary btn-block">
                        </div>
